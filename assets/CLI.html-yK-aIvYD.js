import{_ as r,b as o,c as p,d as i,e,f as a,w as s,h as l,g as t}from"./app-CA0NuOq4.js";const c={},d=e("h1",{id:"befehlszeile",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#befehlszeile"},[e("span",null,"Befehlszeile")])],-1),u=e("p",null,"Alle mit Hyperion ausgelieferten ausführbaren Dateien haben einige Befehlszeilenargumente/Optionen",-1),m={class:"table-of-contents"},h=l(`<h2 id="hyperiond" tabindex="-1"><a class="header-anchor" href="#hyperiond"><span>hyperiond</span></a></h2><p>Das Herzstück von Hyperion</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># Zeigt die Version/Build-Datum/Commit von Hyperion an </span>
...
</code></pre></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Wenn ein Pfadname Leerzeichen enthält, dann umschließe ihn mit <code>&quot;</code> . <br><code>hyperiond --userdata &quot;/temp/another Dir&quot;</code></p></div><h2 id="hyperion-remote" tabindex="-1"><a class="header-anchor" href="#hyperion-remote"><span>hyperion-remote</span></a></h2><p>hyperion-remote ist ein Kommandozeilen-Tool, das vorgegebene Argumente in JSON-Befehle übersetzt und diese an den Hyperion JSON-RPC sendet. Es ist ideal für Skripte geeignet. Es unterstützt fast alle Befehle, die Hyperion zur Verfügung stellt.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># Eine Liste aller verfügbaren Befehle abrufen</span>
...
</code></pre></div><p>Beispiel mit einem Aufnahmeintervall von 15 Bildern pro Sekunde (fps)</p><div class="language-text" data-ext="text" data-title="text"><pre class="language-text"><code>hyperion-qt -f 15
</code></pre></div>`,17);function k(f,b){const n=o("router-link");return p(),i("div",null,[d,u,e("nav",m,[e("ul",null,[e("li",null,[a(n,{to:"#hyperiond"},{default:s(()=>[t("hyperiond")]),_:1})]),e("li",null,[a(n,{to:"#hyperion-remote"},{default:s(()=>[t("hyperion-remote")]),_:1})]),e("li",null,[a(n,{to:"#hyperion-capture"},{default:s(()=>[t("hyperion-capture")]),_:1})])])]),h])}const y=r(c,[["render",k],["__file","CLI.html.vue"]]),v=JSON.parse('{"path":"/de/user/advanced/CLI.html","title":"Befehlszeile","lang":"de-DE","frontmatter":{},"headers":[{"level":2,"title":"hyperiond","slug":"hyperiond","link":"#hyperiond","children":[]},{"level":2,"title":"hyperion-remote","slug":"hyperion-remote","link":"#hyperion-remote","children":[]},{"level":2,"title":"hyperion-capture","slug":"hyperion-capture","link":"#hyperion-capture","children":[]}],"git":{"updatedTime":1710708004000},"filePathRelative":"de/user/advanced/CLI.md"}');export{y as comp,v as data};

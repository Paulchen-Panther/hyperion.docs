...
</code></pre></div><p>Sample with a capture interval of 15 frames per second (fps)</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>hyperion-qt <span class="token parameter variable">-f</span> <span class="token number">15</span>
</code></pre></div>`,19),r=[o];function p(i,l){return n(),a("div",null,r)}const d=e(t,[["render",p],["__file","CLI.html.vue"]]),m=JSON.parse('{"path":"/user/advanced/CLI.html","title":"Command Line Interface","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"hyperiond","slug":"hyperiond","link":"#hyperiond","children":[]},{"level":2,"title":"hyperion-remote","slug":"hyperion-remote","link":"#hyperion-remote","children":[]},{"level":2,"title":"hyperion-capture","slug":"hyperion-capture","link":"#hyperion-capture","children":[]}],"git":{"updatedTime":1710797925000},"filePathRelative":"user/advanced/CLI.md"}');export{d as comp,m as data};
